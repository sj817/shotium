...
class VIZ_HOST_EXPORT HostFrameSinkManager
 ...
 public:
  ...
  // The two CreateVideoCapturer() overloads were here. FrameSinkVideoCapturer
  // streams a frame sink as video; its mojom carries media.mojom types and
  // is deleted. A screenshot reads the surface directly instead.
