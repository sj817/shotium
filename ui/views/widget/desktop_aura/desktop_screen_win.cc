...
std::unique_ptr<display::Screen> CreateDesktopScreen() {
  // The --headless branch returned a DesktopScreenWinHeadless, which drove a
  // set of virtual displays declared by //headless. That component is gone and
  // shot installs its own display::Screen before this is ever reached.
