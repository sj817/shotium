...
// GetWebUiCssTextDefaults() and AppendWebUiCssTextDefaults() were declared
// here. They served the common text styles for chrome:// pages out of
// ui/webui/resources, which is deleted, and neither had a caller.
