...
// GetWebUiCssTextDefaults() and AppendWebUiCssTextDefaults() lived here. Both
// read IDR_WEBUI_CSS_TEXT_DEFAULTS_CSS out of ui/webui/resources, which went
// with the WebUI resource tree, and neither had a caller anywhere in this tree
// -- they styled chrome:// pages, which this binary never loads.
