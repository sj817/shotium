...
// The Dawn and WebNN representations are gone: Dawn was removed with WebGPU,
// and //services/webnn with the ML stack. Both were only ever reachable
// through SharedImageBacking::ProduceDawn / ProduceWebNNTensor.
