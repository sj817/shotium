...
// The WebGPU client wire forward declarations and the WebGPU-specific
// ClientSharedImage accessors (BeginWebGPUTextureAccess/BufferAccess and the
// WebGPUTextureScopedAccess/WebGPUBufferScopedAccess classes) are gone with
// Dawn.
