...
// WebGPUTextureScopedAccess and WebGPUBufferScopedAccess (and the
// BeginWebGPUTextureAccess/BeginWebGPUBufferAccess entry points that created
// them) are gone with Dawn.
