...
void GpuChannel::CreateCommandBuffer(
  ...
  switch (init_params->attribs->which()) {
    ...
    case mojom::ContextCreationAttribs::Tag::kWebgpu:
      // WebGPUCommandBufferStub is gone with Dawn/WebGPU; there is no
      // implementation left to construct here.
      DLOG(ERROR) << "ContextResult::kFatalFailure: WebGPU is not supported";
      return;
  }
