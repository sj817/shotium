...
struct ScreenshotRequest {
  ...
  // PNG is lossless in both modes. "fast" is the performance-first default;
  // "balanced" spends more CPU to produce a smaller file.
  std::string png_compression = "fast";  // fast | balanced
