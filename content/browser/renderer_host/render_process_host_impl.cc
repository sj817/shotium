...
bool RenderProcessHostImpl::Init() {
  ...
  // BackgroundTracingManagerImpl::ActivateForProcess() was here. It
  // handed the child's background tracing agent provider to the
  // browser so a trigger could start a trace. //services/tracing is
  // cut, so there is no agent and no collector.
