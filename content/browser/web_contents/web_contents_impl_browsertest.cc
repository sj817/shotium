...
// DISABLED_IsLoadingExcludingAdSubframesTopLevelNavigation was here. It marked
// an iframe an ad with RenderFrameHost::UpdateIsAdFrame() and then asked
// WebContents::IsLoadingExcludingAdSubframes() whether the page still counted
// as loading. Both calls went with ad tagging.
