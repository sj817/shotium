...
void TracingHandler::OnRecordingEnabled(std::unique_ptr<StartCallback> callback,
  ...
  // Trace screenshots came from viz's FrameSinkVideoCapturer, whose mojom
  // carries media.mojom types. media/mojo is deleted, so traces are recorded
  // without the devtools.screenshot frames.
}
