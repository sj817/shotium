...
// PA_BUILDFLAG(ENABLE_THREAD_ISOLATION) used to instantiate V8's
// ThreadIsolatedAllocator here (gin::GetThreadIsolationData()). Thread
// isolation only ever protected the V8 code pages, and there is no V8, so
