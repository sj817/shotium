...
class WebContents : public PageNavigator, public base::SupportsUserData {
 ...
 public:
  ...
  // IsLoadingExcludingAdSubframes() was here. It answered IsLoading() while
  // skipping ad-tagged subframes; nothing in this build can tag a subframe as
  // an ad, so it could only ever repeat IsLoading().
