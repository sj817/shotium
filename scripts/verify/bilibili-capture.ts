...
//
// The first argument is the package directory to load (a checkout's apps/typescript/,
...
import type {CaptureStats, ScreenshotTile} from '../../apps/typescript/src/types.ts';
...
if (process.argv[1] && path.resolve(process.argv[1]) === import.meta.filename) {
  const cli = cac('pnpm bilibili:capture');
