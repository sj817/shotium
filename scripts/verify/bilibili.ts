...
//   pnpm verify:bilibili --package apps/typescript      # and the engine renders them whole
//
...
const cli = cac('pnpm verify:bilibili');
cli.command('', 'offline regressions for the two Bilibili article fixtures')
    ...
    .option('--package <dir>', 'the package directory to load', {default: 'apps/typescript'})
