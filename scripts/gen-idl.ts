...
const GENERATOR = {enums: 'tools/shot/gen_idl_enums.py', unions: 'tools/shot/gen_idl_unions.py', dictionaries: 'tools/shot/gen_idl_dictionaries.py', buildGni: 'tools/shot/gen_idl_build_gni.py'};
const BANNER_PREFIX = 'tools/shot/';
...
# ${BANNER_PREFIX}gen_idl_*.py. Upstream produced these from the same .idl files
