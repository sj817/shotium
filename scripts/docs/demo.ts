// Regenerates apps/docs/assets/demo.gif from apps/demo-card/demo.tape.
//
//   pnpm docs:demo
//
...
const TAPE = path.join('apps', 'demo-card', 'demo.tape');
const TERMINAL_OUTPUT = path.join(repoRoot, 'apps', 'demo-card', '.demo-terminal.gif');
const CARD = path.join(repoRoot, 'apps', 'docs', 'assets', 'card.webp');
const OUTPUT = path.join(repoRoot, 'apps', 'docs', 'assets', 'demo.gif');
