...
//   pnpm docs:assets
//
// Three files land in apps/docs/assets:
//
//   card.webp          apps/demo-card/card.html, rendered by shotium itself
//   example-node.webp  apps/demo-card/card.mjs, frozen as syntax-highlighted code
...
// recorded in apps/demo-card/cli-session.txt is reused, so the image can always be
