...
// DEPS entry's decision (scripts/tree/prune-deps.ts), not the build graph's.
...
const whitelist = [
  ...
  'package.json',
  '.claude/', '.github/', 'apps/',  'build_overrides/',
  'buildtools/', 'build/args/', 'build/config/shot_build.gni', 'scripts/',
  'shot/', 
