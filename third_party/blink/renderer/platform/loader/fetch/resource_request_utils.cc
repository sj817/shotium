...
void UpgradeResourceRequestForLoader(
  ...
  // The request was annotated here from the FetchContext -- filterlist match,
  // or the AdTracker's read of the v8 stack that issued it. Neither input
  // exists, so no request carries an ad annotation.
