...
class PLATFORM_EXPORT Resource : public GarbageCollected<Resource>,
 ...
 public:
  ...
  // SetIsAdResource() was here. It forwarded an ad annotation onto the
  // ResourceRequest; ResourceRequest no longer carries one, because nothing in
  // this build can decide that a resource belongs to an ad.
