...
//
// Generated by tools/shot/gen_idl_enums.py from third_party/blink/renderer/core/html/forms/html_input_element.idl.
...
// IDL enumeration SelectionMode.
class V8SelectionMode final : public bindings::EnumerationBase {
 public:
  ...
  constexpr V8SelectionMode(Enum value)
