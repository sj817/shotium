...
//
// Generated by tools/shot/gen_idl_enums.py from third_party/blink/renderer/core/frame/scroll_options.idl.
...
// IDL enumeration ScrollBehavior.
class V8ScrollBehavior final : public bindings::EnumerationBase {
 public:
  ...
  constexpr V8ScrollBehavior(Enum value)
