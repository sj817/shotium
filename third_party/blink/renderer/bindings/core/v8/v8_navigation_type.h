...
//
// Generated by tools/shot/gen_idl_enums.py from third_party/blink/renderer/core/navigation_api/navigation_type.idl.
...
// IDL enumeration NavigationType.
class V8NavigationType final : public bindings::EnumerationBase {
 public:
  ...
  constexpr V8NavigationType(Enum value)
