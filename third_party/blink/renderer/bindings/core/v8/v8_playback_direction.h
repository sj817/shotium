...
//
// Generated by tools/shot/gen_idl_enums.py from third_party/blink/renderer/core/animation/effect_timing.idl.
...
// IDL enumeration PlaybackDirection.
class V8PlaybackDirection final : public bindings::EnumerationBase {
 public:
  ...
  constexpr V8PlaybackDirection(Enum value)
