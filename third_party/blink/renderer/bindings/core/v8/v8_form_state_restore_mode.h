...
//
// Generated by tools/shot/gen_idl_enums.py from third_party/blink/renderer/core/html/custom/custom_element_registry.idl.
...
// IDL enumeration FormStateRestoreMode.
class V8FormStateRestoreMode final : public bindings::EnumerationBase {
 public:
  ...
  constexpr V8FormStateRestoreMode(Enum value)
