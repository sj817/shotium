...
//
// Generated by tools/shot/gen_idl_dictionaries.py from third_party/blink/renderer/core/view_transition/page_reveal_event_init.idl.
...
// IDL dictionary PageRevealEventInit.
class CORE_EXPORT PageRevealEventInit : public EventInit {
 public:
  static PageRevealEventInit* Create() { return MakeGarbageCollected<PageRevealEventInit>(); }

  PageRevealEventInit() = default;
  ~PageRevealEventInit() override = default;
