...
//
// Generated by tools/shot/gen_idl_enums.py from third_party/blink/renderer/core/css/font_face.idl.
...
// IDL enumeration FontFaceLoadStatus.
class V8FontFaceLoadStatus final : public bindings::EnumerationBase {
 public:
  ...
  constexpr V8FontFaceLoadStatus(Enum value)
