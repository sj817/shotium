...
//
// Generated by tools/shot/gen_idl_enums.py from third_party/blink/renderer/core/frame/scroll_into_view_options.idl.
...
// IDL enumeration ScrollLogicalPosition.
class V8ScrollLogicalPosition final : public bindings::EnumerationBase {
 public:
  ...
  constexpr V8ScrollLogicalPosition(Enum value)
