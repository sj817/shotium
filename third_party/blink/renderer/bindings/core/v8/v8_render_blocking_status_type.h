...
//
// Generated by tools/shot/gen_idl_enums.py from third_party/blink/renderer/core/timing/performance_resource_timing.idl.
...
// IDL enumeration RenderBlockingStatusType.
class V8RenderBlockingStatusType final : public bindings::EnumerationBase {
 public:
  ...
  constexpr V8RenderBlockingStatusType(Enum value)
