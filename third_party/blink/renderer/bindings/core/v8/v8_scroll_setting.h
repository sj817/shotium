...
//
// Generated by tools/shot/gen_idl_enums.py from third_party/blink/renderer/core/html/track/vtt/vtt_region.idl.
...
// IDL enumeration ScrollSetting.
class V8ScrollSetting final : public bindings::EnumerationBase {
 public:
  ...
  constexpr V8ScrollSetting(Enum value)
