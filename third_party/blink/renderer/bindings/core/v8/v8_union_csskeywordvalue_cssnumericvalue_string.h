...
// IDL union (CSSNumericValue or CSSKeywordish).
class V8UnionCSSKeywordValueOrCSSNumericValueOrString final : public bindings::UnionBase {
 public:
  ...
  explicit V8UnionCSSKeywordValueOrCSSNumericValueOrString(CSSKeywordValue* value)
      : content_type_(ContentType::kCSSKeywordValue), member_css_keyword_value_(value) {
    DCHECK(value);
  }
