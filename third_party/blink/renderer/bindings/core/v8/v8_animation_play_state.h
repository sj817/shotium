...
//
// Generated by tools/shot/gen_idl_enums.py from third_party/blink/renderer/core/animation/animation.idl.
...
// IDL enumeration AnimationPlayState.
class V8AnimationPlayState final : public bindings::EnumerationBase {
 public:
  ...
  constexpr V8AnimationPlayState(Enum value)
