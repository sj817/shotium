...
//
// Generated by tools/shot/gen_idl_enums.py from third_party/blink/renderer/core/dom/shadow_root_init.idl.
...
// IDL enumeration SlotAssignmentMode.
class V8SlotAssignmentMode final : public bindings::EnumerationBase {
 public:
  ...
  constexpr V8SlotAssignmentMode(Enum value)
