...
//
// Generated by tools/shot/gen_idl_enums.py from third_party/blink/renderer/core/fileapi/blob_property_bag.idl.
...
// IDL enumeration EndingType.
class V8EndingType final : public bindings::EnumerationBase {
 public:
  ...
  constexpr V8EndingType(Enum value)
