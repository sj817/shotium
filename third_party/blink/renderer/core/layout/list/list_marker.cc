...
void DestroyLayoutObject(LayoutObject* layout_object) {
  // Used to manually remove the accessibility objects for the destroyed
  // list marker layout object from the AXObjectCache; no accessibility
  // tree exists to remove them from anymore.
