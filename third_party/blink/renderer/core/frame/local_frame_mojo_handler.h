...
class LocalFrameMojoHandler
 ...
 private:
  ...
  void PostMessageEvent(
      ...
      mojom::blink::TransferableMessagePtr message) final;
  ...
  // TraverseCancelled and DispatchNavigateEventForCrossDocumentTraversal were
  // mojom::blink::LocalFrame methods that only existed to drive the
  // navigation API; both the API and the corresponding mojom methods are
  // gone (see frame.mojom).
