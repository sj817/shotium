...
// Represents a pending preload or prefetch link. Receives callbacks when the
// loading finishes or errors.
class PendingLinkPreload final : public GarbageCollected<PendingLinkPreload>,
                                 public NameClient {
 public:
