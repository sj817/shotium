...
class CORE_EXPORT CSSStyleDeclaration : public ScriptWrappable,
 ...
 public:
  ...
  // AnonymousNamedDeleter() returned a NamedPropertyDeleterResult, an enum
  // declared in platform/bindings/v8_binding.h. Only a v8 named-property
  // interceptor ever called it.
