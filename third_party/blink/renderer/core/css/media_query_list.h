...
class CORE_EXPORT MediaQueryList final
 ...
 public:
  ...
  // addDeprecatedListener()/removeDeprecatedListener() were here: the
  // legacy MediaQueryList.addListener(fn) spelling of
  // addEventListener("change", fn). Their argument is a script callback.
