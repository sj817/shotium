...
class CORE_EXPORT CSSParserContext final
 ...
 private:
  ...
  // The ad-related bit was here. It came from AdTracker walking the V8 stack
  // at stylesheet creation, or from a ResourceRequest a filterlist rule had
  // flagged. Neither producer exists, so no parser context can be ad-related.
