...
void TextFragmentPainter::Paint(const PaintInfo& paint_info,
  ...
  // A MobileFriendlinessChecker::NotifyPaintTextFragment() call was here: it
  // reported this text fragment's clipped rect and font size toward a
  // mobile-usability UKM score. All of it fed a UKM score;
