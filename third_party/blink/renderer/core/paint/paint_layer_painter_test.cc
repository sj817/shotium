...
// DevtoolsPaintTraceEvents was here: it asserted that a "Paint" trace event
// under the "devtools.timeline" category carried "clip"/"frame"/"nodeId"
// fields shaped exactly like core/inspector's (deleted)
// InspectorPaintEvent::Data. That producer is gone with the rest of
// core/inspector's DevTools timeline instrumentation, so no such event fires
// anymore; there's nothing left here for this test to observe.
