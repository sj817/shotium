...
class ScopedBoxContentsPaintState : public ScopedPaintState {
 ...
 private:
  ...
  // mf_ignore_scope_ was a MobileFriendlinessChecker::IgnoreBeyondViewportScope:
  // it told the mobile-friendliness telemetry not to count content painted
  // beyond the viewport by a scroller or a position:fixed box.
  // core/mobile_metrics is cut.
};
