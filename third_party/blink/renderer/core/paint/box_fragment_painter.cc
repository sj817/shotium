...
// fragment red and stamped an "AD" glyph over it when Element::ShouldHighlightAd()
// was true. Nothing in this build can mark an element ad-related, and the
// "Highlight ads" setting that gated it is gone with the rest of ad tagging.
