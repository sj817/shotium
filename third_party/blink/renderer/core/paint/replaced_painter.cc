...
class ScopedReplacedContentPaintState : public ScopedPaintState {
 public:
  ...
  // mf_ignore_scope_ (a MobileFriendlinessChecker::IgnoreBeyondViewportScope)
  // was here; core/mobile_metrics is cut.
};
...
ScopedReplacedContentPaintState::ScopedReplacedContentPaintState(
  ...
  // The replaced content rect was reported to MobileFriendlinessChecker here.
