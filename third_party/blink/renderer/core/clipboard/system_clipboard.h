...
class CORE_EXPORT SystemClipboard final
 ...
 public:
  ...
  struct ClipboardChangeData {
    ...
    // Was `const BigInt change_id` -- blink::BigInt is the V8 wrapper that
    // let script read this as a JS BigInt. The value is the sequence
    // number the browser sent; store it as itself.
