...
void HTMLSelectElement::IncreaseContentModelViolationCount() {
  ...
  // Used to mark the element dirty in AXObjectCache when this count crossed
  // zero, forcing an accessibility tree serialization update. AXObjectCache
...
void HTMLSelectElement::DecreaseContentModelViolationCount() {
  ...
  // Used to mark the element dirty in AXObjectCache when this count dropped
  // back to zero, forcing an accessibility tree serialization update.
