...
void ExternalPatchLoader::ResponseReceived(Resource* resource,
  ...
  // External fragments use the native parser without scripting or plugins.
  constexpr ParserContentPolicy content_policy =
  ...
  parser_ = MakeGarbageCollected<HTMLDocumentParser>(
      ...
      ParserPrefetchPolicy::kDisallowPrefetching, nullptr,
