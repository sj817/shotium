...
class CORE_EXPORT HTMLScriptElement final : public HTMLElement,
 ...
 public:
  ...
  // setSrc() used to live here: an IDL setter taking a (TrustedScriptURL or
  // USVString) and Trusted-Types-checking it before reflecting to the `src`
  // content attribute. It was only ever reachable from script
  // (`script.src = ...`), and this engine has no script engine to call it.
  String src();
