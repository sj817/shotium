...
class CORE_EXPORT CustomElementDefinition
 ...
 public:
  ...
  // GetV8CustomElementConstructor() was here. The constructor is a script
  // function; nothing can supply one, and this class has no concrete
  // subclass left to return it.
