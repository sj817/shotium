...
class CORE_EXPORT HTMLImageElement
 ...
 public:
  ...
  // creator_scripts()/creator_scripts_ removed in this cut along with
  // LCPScriptObserver (see core/frame/local_frame.h): it was only ever
  // populated from LCPScriptObserver::GetExecutingScriptUrls() and had no
  // other reader.
