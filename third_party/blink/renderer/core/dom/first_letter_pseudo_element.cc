...
void FirstLetterPseudoElement::AttachFirstLetterTextLayoutObjects(
  ...
  // Used to manually remove the accessibility object for the destroyed
  // first-letter layout object from the AXObjectCache; no accessibility
  // tree exists to remove it from anymore.
