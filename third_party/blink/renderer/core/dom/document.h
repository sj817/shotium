...
class CORE_EXPORT Document : public ContainerNode,
 ...
 public:
  ...
  NodeIterator* createNodeIterator(Node* root, unsigned what_to_show);
  TreeWalker* createTreeWalker(Node* root, unsigned what_to_show);
  ...
  // ExistingAXObjectCache()/AXObjectCacheOwner()/RefreshAccessibilityTree()
  // gave access to the per-document accessibility tree (AXObjectCache). A
  // static-screenshot engine never builds one, so this accessor surface and
  // the AXContext bookkeeping below (AddAXContext/RemoveAXContext/
  // AXContextModeChanged/ClearAXObjectCache, ax_contexts_, ax_object_cache_)
  // were removed.
  ...
  // GetAnchorElementInteractionTracker() removed with the tracker itself; see
