...
void Node::AttachLayoutTree(AttachContext& context) {
  ...
  // Used to notify the AXObjectCache that this node was attached; no
...
void Node::DetachLayoutTree(bool performing_reattach) {
  ...
  // Used to notify the AXObjectCache to remove this subtree; no
  // accessibility tree exists to notify anymore.
...
Node::InsertionNotificationRequest Node::InsertedInto(
  ...
  // Used to notify the AXObjectCache that this node was connected; no
  // accessibility tree exists to notify anymore.
...
void Node::RemovedFrom(ContainerNode& insertion_point) {
  ...
  // Used to notify the AXObjectCache to remove this node; no accessibility
...
void Node::AddedEventListener(const AtomicString& event_type,
  ...
  // Used to notify the AXObjectCache that a listener was added; no
  // accessibility tree exists to notify anymore.
}
...
void Node::RemoveAllEventListeners() {
  ...
  // Used to notify the AXObjectCache that all listeners were removed; no
  // accessibility tree exists to notify anymore.
}
