...
// V8FrameCallback was here: the adapter that wrapped a script
// FrameRequestCallback as a FrameCallback. FrameCallback itself stays -- blink
// registers its own animation-frame work through this collection -- but there
// is no script callback to adapt.
