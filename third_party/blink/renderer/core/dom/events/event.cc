...
// dom_window_performance.h / window_performance.h / worker_global_scope_
// performance.h used to back a script-exposed Event.timeStamp getter that
// resolved the event's platform_time_stamp_ against a Performance object's
// time origin. That getter (and this event.cc's use of it) is gone along
// with the rest of the JS bindings surface -- these were dead includes, not
// referenced by anything left in this file.
