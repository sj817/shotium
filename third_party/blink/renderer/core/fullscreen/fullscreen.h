...
class CORE_EXPORT Fullscreen final : public GarbageCollected<Fullscreen>,
 ...
 public:
  ...
  // Used to return a promise resolved when the browser entered fullscreen and
  // rejected with the reason otherwise. Callers observe the outcome through
  // the fullscreenchange/fullscreenerror events instead.
  static void RequestFullscreen(Element&,
 ...
 private:
  ...
  // Number of exit-fullscreen requests waiting on the browser process.
  wtf_size_t pending_exits_ = 0;
