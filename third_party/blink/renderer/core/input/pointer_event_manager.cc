...
WebInputEventResult PointerEventManager::DispatchPointerEvent(
  ...
  if (event_type == event_type_names::kPointerdown ||
    ...
    // AnchorElementInteractionTracker heard about this so the browser could
    // start preconnecting to the link the pointer was heading for. There is no
    // browser process to preconnect and no second navigation to speed up.
  }
