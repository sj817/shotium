...
结论：本次结果不完整。5 个平台形成了有效的平台内对比；缺失结果不会被推测或补齐。
...
| linux-arm64 | 噪声过大 | shotium | 1 | 10 |
| win32-x64 | 基础设施错误 | shotium | 5 | 1 |
...
| 不授予名次（覆盖不完整） | puppeteer-shell | 4.230× | 7 | 9 / 10 | 0 |
| 不授予名次（覆盖不完整） | playwright-chrome | 4.758× | 5 | 7 / 10 | 0 |
| 不授予名次（覆盖不完整） | puppeteer-chrome | 6.334× | 6 | 7 / 10 | 0 |
...
- playwright-chrome: `冷启动/并发1`、`冷启动稳定后首张/并发1`、`启动—截图—关闭循环/并发1`、`并发截图/并发1`、`并发截图/并发2`、`并发截图/并发4`、`常驻引擎新客户端/并发1`
...
|:--|--:|:--|:--|:--|--:|--:|--:|--:|
| 冷启动 | 1 | shotium | 通过 | 是 | 53 | 54 | 18.919 | 1.00× |
| 冷启动 | 1 | playwright-chrome | 通过 | 是 | 410 | 464 | 2.396 | 7.74× |
| 冷启动 | 1 | puppeteer-shell | 通过 | 是 | 282 | 375 | 3.235 | 5.32× |
| 冷启动 | 1 | puppeteer-chrome | 通过 | 是 | 471 | 642 | 2.044 | 8.89× |
| 冷启动 | 1 | playwright-shell | 通过 | 是 | 256 | 281 | 3.857 | 4.83× |
| 冷启动稳定后首张 | 1 | puppeteer-shell | 通过 | 是 | 104.061 | 124.113 | 9.287 | 4.95× |
| 冷启动稳定后首张 | 1 | puppeteer-chrome | 通过 | 是 | 114.146 | 142.731 | 8.569 | 5.43× |
| 冷启动稳定后首张 | 1 | playwright-chrome | 通过 | 是 | 118.888 | 170.457 | 7.536 | 5.65× |
| 冷启动稳定后首张 | 1 | shotium | 通过 | 是 | 21.028 | 21.967 | 46.435 | 1.00× |
| 冷启动稳定后首张 | 1 | playwright-shell | 通过 | 是 | 95.619 | 105.772 | 10.494 | 4.55× |
| 启动—截图—关闭循环 | 1 | shotium | 通过 | 是 | 53.989 | 80.148 | 16.839 | 1.00× |
| 启动—截图—关闭循环 | 1 | puppeteer-chrome | 通过 | 是 | 565.139 | 1648.594 | 1.548 | 10.47× |
| 启动—截图—关闭循环 | 1 | puppeteer-shell | 通过 | 是 | 289.344 | 409.664 | 3.402 | 5.36× |
| 启动—截图—关闭循环 | 1 | playwright-shell | 通过 | 是 | 262.976 | 301.556 | 3.901 | 4.87× |
| 启动—截图—关闭循环 | 1 | playwright-chrome | 通过 | 是 | 488.753 | 723.828 | 1.978 | 9.05× |
| 预热截图 | 1 | playwright-chrome | 噪声过大 | 否 | 145.381 | 179.195 | 2.815 | 不适用 |
| 预热截图 | 1 | shotium | 通过 | 是 | 24.905 | 29.44 | 38.201 | 1.00× |
| 预热截图 | 1 | puppeteer-chrome | 通过 | 是 | 157.438 | 201.988 | 6.217 | 6.32× |
| 预热截图 | 1 | playwright-shell | 通过 | 是 | 122.864 | 149.809 | 8.026 | 4.93× |
| 预热截图 | 1 | puppeteer-shell | 通过 | 是 | 131.601 | 157.137 | 7.542 | 5.28× |
| 顺序批量 | 1 | playwright-shell | 通过 | 是 | 138.668 | 360.009 | 6.215 | 4.31× |
| 顺序批量 | 1 | puppeteer-shell | 通过 | 是 | 147.616 | 349.613 | 5.845 | 4.59× |
| 顺序批量 | 1 | shotium | 通过 | 是 | 32.151 | 267.234 | 18.545 | 1.00× |
| 顺序批量 | 1 | playwright-chrome | 噪声过大 | 否 | 165.397 | 374.801 | 4.373 | 不适用 |
| 顺序批量 | 1 | puppeteer-chrome | 通过 | 是 | 187.216 | 401.322 | 4.816 | 5.82× |
| 并发截图 | 1 | playwright-shell | 通过 | 是 | 107.387 | 1160.162 | 6.843 | 3.65× |
| 并发截图 | 1 | playwright-chrome | 通过 | 是 | 137.004 | 358.306 | 6.273 | 4.65× |
| 并发截图 | 1 | puppeteer-chrome | 通过 | 是 | 149.739 | 375.189 | 5.844 | 5.09× |
| 并发截图 | 1 | puppeteer-shell | 通过 | 是 | 120.234 | 330.217 | 6.806 | 4.08× |
| 并发截图 | 1 | shotium | 通过 | 是 | 29.44 | 258.629 | 20.560 | 1.00× |
| 并发截图 | 2 | puppeteer-chrome | 通过 | 是 | 255.832 | 427.23 | 6.888 | 4.33× |
| 并发截图 | 2 | puppeteer-shell | 通过 | 是 | 214.92 | 624.344 | 7.957 | 3.63× |
| 并发截图 | 2 | shotium | 通过 | 是 | 59.133 | 290.96 | 20.488 | 1.00× |
| 并发截图 | 2 | playwright-shell | 通过 | 是 | 188.534 | 348.728 | 8.873 | 3.19× |
| 并发截图 | 2 | playwright-chrome | 通过 | 是 | 238.892 | 588.97 | 7.556 | 4.04× |
| 并发截图 | 4 | shotium | 通过 | 是 | 128.032 | 347.711 | 20.665 | 1.00× |
| 并发截图 | 4 | playwright-shell | 通过 | 是 | 355.746 | 600.237 | 9.743 | 2.78× |
| 并发截图 | 4 | playwright-chrome | 通过 | 是 | 406.883 | 595.639 | 8.416 | 3.18× |
| 并发截图 | 4 | puppeteer-chrome | 失败 | 否 | 472.409 | 920.936 | 7.578 | 不适用 |
| 并发截图 | 4 | puppeteer-shell | 通过 | 是 | 391.442 | 609.159 | 9.002 | 3.06× |
...
| 常驻引擎新客户端 | 1 | shotium | 通过 | 是 | 455 | 465 | 2.222 | 1.00× |
| 常驻引擎新客户端 | 1 | puppeteer-chrome | 噪声过大 | 否 | 15305.456 | 15810.345 | 不适用 | 不适用 |
| 常驻引擎新客户端 | 1 | playwright-shell | 通过 | 是 | 971 | 1042 | 1.038 | 2.13× |
| 常驻引擎新客户端 | 1 | puppeteer-shell | 噪声过大 | 否 | 767.5 | 825 | 0.094 | 不适用 |
| 常驻引擎新客户端 | 1 | playwright-chrome | 通过 | 是 | 1061 | 1095 | 0.957 | 2.33× |
...
| 持续压力 | 4 | playwright-shell | 通过 | 是 | 403.487 | 885.848 | 9.084 | 2.44× |
| 持续压力 | 4 | puppeteer-shell | 通过 | 是 | 460.5 | 856.388 | 8.358 | 2.79× |
| 持续压力 | 4 | shotium | 通过 | 是 | 165.14 | 387.537 | 19.653 | 1.00× |
...
|--:|:--|--:|--:|--:|--:|
| 1 | shotium | 1.000× | 8 | 10 / 10 | 10 |
| 不授予名次（覆盖不完整） | playwright-shell | 2.634× | 7 | 9 / 10 | 0 |
| 不授予名次（覆盖不完整） | playwright-chrome | 3.749× | 7 | 9 / 10 | 0 |
...
| 场景 | 并发 | 引擎 | 状态 | 参与排名 | p50 毫秒 | 最差毫秒 | 吞吐量/秒 | 相对 Shotium |
|:--|--:|:--|:--|:--|--:|--:|--:|--:|
| 冷启动 | 1 | playwright-shell | 通过 | 是 | 230 | 238 | 4.345 | 3.65× |
| 冷启动 | 1 | shotium | 通过 | 是 | 63 | 67 | 15.730 | 1.00× |
| 冷启动 | 1 | playwright-chrome | 通过 | 是 | 406 | 1069 | 2.020 | 6.44× |
| 冷启动稳定后首张 | 1 | playwright-chrome | 噪声过大 | 否 | 120.816 | 132.088 | 1.845 | 不适用 |
| 冷启动稳定后首张 | 1 | shotium | 通过 | 是 | 34.088 | 34.76 | 29.329 | 1.00× |
| 冷启动稳定后首张 | 1 | playwright-shell | 通过 | 是 | 110.935 | 123.177 | 9.125 | 3.25× |
| 启动—截图—关闭循环 | 1 | shotium | 通过 | 是 | 73.365 | 101.532 | 12.932 | 1.00× |
| 启动—截图—关闭循环 | 1 | playwright-shell | 通过 | 是 | 238.236 | 312.762 | 4.085 | 3.25× |
| 启动—截图—关闭循环 | 1 | playwright-chrome | 通过 | 是 | 418.73 | 494.885 | 2.362 | 5.71× |
| 预热截图 | 1 | shotium | 通过 | 是 | 32.049 | 34.055 | 30.984 | 1.00× |
| 预热截图 | 1 | playwright-chrome | 通过 | 是 | 117.495 | 158.248 | 8.267 | 3.67× |
| 预热截图 | 1 | playwright-shell | 通过 | 是 | 103.611 | 132.446 | 9.290 | 3.23× |
| 顺序批量 | 1 | playwright-shell | 通过 | 是 | 124.002 | 323.849 | 7.079 | 2.89× |
| 顺序批量 | 1 | playwright-chrome | 通过 | 是 | 142.813 | 356.542 | 6.137 | 3.33× |
| 顺序批量 | 1 | shotium | 通过 | 是 | 42.861 | 260.261 | 16.716 | 1.00× |
| 并发截图 | 1 | playwright-chrome | 通过 | 是 | 152.331 | 356.975 | 5.805 | 3.45× |
| 并发截图 | 1 | playwright-shell | 通过 | 是 | 126.921 | 348.32 | 6.861 | 2.87× |
| 并发截图 | 1 | shotium | 通过 | 是 | 44.16 | 262.453 | 16.439 | 1.00× |
| 并发截图 | 2 | playwright-shell | 通过 | 是 | 184.844 | 343.981 | 8.918 | 2.05× |
| 并发截图 | 2 | shotium | 通过 | 是 | 90.209 | 295.828 | 16.317 | 1.00× |
| 并发截图 | 2 | playwright-chrome | 通过 | 是 | 251.896 | 413.124 | 7.179 | 2.79× |
| 并发截图 | 4 | shotium | 通过 | 是 | 184.187 | 379.566 | 16.228 | 1.00× |
| 并发截图 | 4 | playwright-chrome | 通过 | 是 | 438.408 | 608.686 | 8.080 | 2.38× |
| 并发截图 | 4 | playwright-shell | 通过 | 是 | 343.492 | 544.654 | 9.785 | 1.86× |
...
| 常驻引擎新客户端 | 1 | playwright-chrome | 通过 | 是 | 629 | 876 | 1.542 | 6.84× |
| 常驻引擎新客户端 | 1 | shotium | 通过 | 是 | 92 | 249 | 8.526 | 1.00× |
...
| 持续压力 | 4 | playwright-shell | 通过 | 是 | 308.776 | 597.304 | 11.949 | 1.54× |
| 持续压力 | 4 | playwright-chrome | 通过 | 是 | 417.275 | 753.151 | 9.330 | 2.08× |
| 持续压力 | 4 | shotium | 通过 | 是 | 200.7 | 451.49 | 16.216 | 1.00× |
...
| 启动—截图—关闭循环 | 1 | shotium | 通过 | 是 | 112.285 | 238.905 | 8.263 | 1.00× |
| 启动—截图—关闭循环 | 1 | puppeteer-chrome | 通过 | 是 | 1904.429 | 2179.802 | 0.534 | 16.96× |
| 启动—截图—关闭循环 | 1 | puppeteer-shell | 通过 | 是 | 963.584 | 1077.043 | 1.032 | 8.58× |
| 启动—截图—关闭循环 | 1 | playwright-shell | 通过 | 是 | 607.973 | 759.499 | 1.634 | 5.41× |
| 启动—截图—关闭循环 | 1 | playwright-chrome | 通过 | 是 | 1275.404 | 1419.992 | 0.777 | 11.36× |
...
| 启动—截图—关闭循环 | 1 | shotium | 通过 | 是 | 193.911 | 446.878 | 4.655 | 1.00× |
| 启动—截图—关闭循环 | 1 | puppeteer-chrome | 通过 | 是 | 3579.117 | 5841.001 | 0.266 | 18.46× |
| 启动—截图—关闭循环 | 1 | puppeteer-shell | 通过 | 是 | 1366.161 | 1681.9 | 0.744 | 7.05× |
| 启动—截图—关闭循环 | 1 | playwright-shell | 通过 | 是 | 1052.71 | 1397.548 | 0.928 | 5.43× |
| 启动—截图—关闭循环 | 1 | playwright-chrome | 通过 | 是 | 3232.154 | 3828.663 | 0.307 | 16.67× |
...
| 启动—截图—关闭循环 | 1 | shotium | 通过 | 是 | 98.453 | 166.222 | 9.790 | 1.00× |
| 启动—截图—关闭循环 | 1 | puppeteer-chrome | 通过 | 是 | 1467.059 | 2206.518 | 0.649 | 14.90× |
| 启动—截图—关闭循环 | 1 | puppeteer-shell | 通过 | 是 | 470.985 | 821.312 | 2.011 | 4.78× |
| 启动—截图—关闭循环 | 1 | playwright-shell | 通过 | 是 | 338.848 | 680.385 | 2.723 | 3.44× |
| 启动—截图—关闭循环 | 1 | playwright-chrome | 通过 | 是 | 1523.995 | 1986.194 | 0.666 | 15.48× |
